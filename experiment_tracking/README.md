...
The most basic logging we can do is writing the metric that our model is producing to the terminal or a file for later
...
10. Another awesome feature of wandb is doing hyperparameter sweeps e.g. finding the best parameters for a
    ...
    optimization for you. Try to go over it and try to make sense what is going on. Afterwards execute it
    ...
    tab on the webside, where you should figure out:

    * What combination of parameters lead to the highest accuracy value?
